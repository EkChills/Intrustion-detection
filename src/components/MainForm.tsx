...
const MainForm = ({}: Props) => {
  ...
  return (
    <form
      ...
      className="w-full fixed inset-0 flex items-center justify-center px-[2rem] flex-col bg-base-100"
    >
      ...
      <div className="bg-neutral rounded-md p-[2rem] font-bold text-2xl min-w-[20rem] w-full max-w-[35rem] flex flex-col space-y-[1rem] items-start overflow-y-scroll max-h-[35rem]">
